...
Fork the project [on GitHub](https://github.com/geut/socket-signal) and check out your copy locally.

```bash
$ git clone git@github.com:username/socket-signal.git
$ cd socket-signal
$ npm install
$ git remote add upstream git://github.com/geut/socket-signal.git
```
