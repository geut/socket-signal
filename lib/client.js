...
class SocketSignalClient extends NanoresourcePromise {
  ...
  constructor (socket, opts = {}) {
    ...
    const { id = crypto.randomBytes(32), timeout = 5 * 1000, metadata, simplePeer = {}, concurrency = 1 } = opts
  ...
  [kAddPeer] (peer, offer) {
    ...
    const job = async () => {
      ...
      return this[kIterateSignal](peer, offer)
    }
   ...
   * @private
   */
  async [kIterateSignal] (peer, offer) {
