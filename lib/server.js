...
class SocketSignalServer extends NanoresourcePromise {
  constructor (opts = {}) {
    ...
    const { onConnect, onDisconnect, onJoin, onLeave, onLookup, onOffer, onSignal, requestTimeout = 5 * 1000, ...rpcOpts } = opts
  ...
  async addSocket (socket) {
    ...
    const rpc = nanomessagerpc(socket, { timeout: this._requestTimeout, ...this._rpcOpts })
